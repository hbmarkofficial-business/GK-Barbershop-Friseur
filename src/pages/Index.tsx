  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Bielefeld | GK Barbershop & Friseur</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop GK Barbershop & Friseur in Bielefeld für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="GK Barbershop & Friseur | Premium Barbershop Bielefeld" />
        <meta
        ...
        <meta name="twitter:title" content="GK Barbershop & Friseur | Premium Barbershop Bielefeld" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "Barbershop",
            "name": "GK Barbershop & Friseur",
            "image": "https://gentlemanscut.de/images/logo.png",
            "address": {
              "@type": "PostalAddress",
              "streetAddress": "Meller Str. 42",
